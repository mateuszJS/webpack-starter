...
/*
  ...
  TS assume that scripts have a global scoping, so there is no way to declare
  the same consts in this file and in the webpack.dev.ts. There are only two options to fix that:
  1) change the name of consts
  2) add import or export, then TS will recognize this file as a module
